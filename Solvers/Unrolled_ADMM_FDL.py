...
class UnrolledADMMFDL(torch.nn.Module):
    def __init__(self, nb_channels=3, nb_iteration=12, nb_fdl=30, rho_initial_val=1.0, device='cpu'):
        ...
        self.denoiser = net(in_nc=nb_channels*nb_fdl+1, out_nc=nb_channels*nb_fdl, nc=[128, 128, 256, 512], nb=8, act_mode='R', downsample_mode="strideconv", upsample_mode="convtranspose")
